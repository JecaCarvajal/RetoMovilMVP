package co.com.eduardo.misiontic.mytask.view.adapter;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.ViewHolder> {
    ...
    private OnItemClickListener longListerner;
    ...
    public void setLongistener(OnItemClickListener listener)
    {
        this.longListerner = listener;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (longListerner != null) {
            holder.itemView.setOnLongClickListener(v -> {
                longListerner.onClick(item);
                return false;
            });
        }
